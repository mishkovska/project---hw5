...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update(
            {'class': 'form-control mb-3', 'placeholder': 'Enter an email'})
        self.fields['password'].widget.attrs.update(
            {'class': 'form-control mb-3', 'placeholder': 'Enter a password'})
...
class UserEditForm(forms.ModelForm):
    ...
    username = forms.CharField(
        label='Username', help_text='Can Not Be Changed', widget=forms.TextInput(
    ...
    first_name = forms.CharField(
        label='Firstname', min_length=4, max_length=50, required=False, help_text='Optional', widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Enter your firstname', 'id': 'form-firstname'}))
    
    last_name = forms.CharField(
        label='Lastname', min_length=4, max_length=50, required=False, help_text='Optional', widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Enter your lastname', 'id': 'form-lastname'}))
    ...
    postcode = forms.CharField(
        label='Postcode', min_length=2, max_length=12, required=False, help_text='Optional', widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Enter your postcode', 'id': 'form-postcode'}))
